...
bool px4_msgs__msg__vehicle_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // rc_input_mode
    PyObject * field = PyObject_GetAttrString(_pymsg, "rc_input_mode");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->rc_input_mode = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // data_link_lost
  ...
  {  // onboard_control_sensors_present
    ...
    assert(PyLong_Check(field));
    ros_message->onboard_control_sensors_present = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // onboard_control_sensors_enabled
    ...
    assert(PyLong_Check(field));
    ros_message->onboard_control_sensors_enabled = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * px4_msgs__msg__vehicle_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // rc_input_mode
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->rc_input_mode);
    {
      int rc = PyObject_SetAttrString(_pymessage, "rc_input_mode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // onboard_control_sensors_present
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->onboard_control_sensors_present);
    {
  ...
  {  // onboard_control_sensors_enabled
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->onboard_control_sensors_enabled);
    {
