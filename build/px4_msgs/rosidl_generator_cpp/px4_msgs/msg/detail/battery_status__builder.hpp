...
{
public:
  explicit Init_BatteryStatus_remaining_capacity(::px4_msgs::msg::BatteryStatus & msg)
  : msg_(msg)
  {}
  Init_BatteryStatus_design_capacity remaining_capacity(::px4_msgs::msg::BatteryStatus::_remaining_capacity_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_BatteryStatus_remaining_capacity available_energy(::px4_msgs::msg::BatteryStatus::_available_energy_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_BatteryStatus_average_power warning(::px4_msgs::msg::BatteryStatus::_warning_type arg)
  {
