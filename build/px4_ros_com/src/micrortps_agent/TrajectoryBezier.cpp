...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a2b953e
    m_timestamp = 0;
    // m_position com.eprosima.idl.parser.typecode.AliasTypeCode@313b2ea6
    memset(&m_position, 0, (3) * 4);
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2f465398
    m_yaw = 0.0;
    // m_delta com.eprosima.idl.parser.typecode.PrimitiveTypeCode@548e6d58
    m_delta = 0.0;
