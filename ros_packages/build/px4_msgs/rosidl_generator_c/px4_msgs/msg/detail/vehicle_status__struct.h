...
/// Constant 'NAVIGATION_STATE_AUTO_LANDGPSFAIL'.
enum
{
  px4_msgs__msg__VehicleStatus__NAVIGATION_STATE_AUTO_LANDGPSFAIL = 9
};
...
enum
{
  px4_msgs__msg__VehicleStatus__NAVIGATION_STATE_UNUSED = 11
};
...
enum
{
  px4_msgs__msg__VehicleStatus__NAVIGATION_STATE_MAX = 22
};

/// Constant 'RC_IN_MODE_DEFAULT'.
enum
{
  px4_msgs__msg__VehicleStatus__RC_IN_MODE_DEFAULT = 0
};

/// Constant 'RC_IN_MODE_OFF'.
enum
{
  px4_msgs__msg__VehicleStatus__RC_IN_MODE_OFF = 1
};

/// Constant 'RC_IN_MODE_GENERATED'.
enum
{
  px4_msgs__msg__VehicleStatus__RC_IN_MODE_GENERATED = 2
};
