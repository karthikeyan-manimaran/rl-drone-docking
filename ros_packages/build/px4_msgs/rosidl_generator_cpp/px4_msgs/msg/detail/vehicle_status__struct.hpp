...
struct VehicleStatus_
{
  ...
  explicit VehicleStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->onboard_control_sensors_present = 0ul;
      this->onboard_control_sensors_enabled = 0ul;
  ...
  Type & set__rc_input_mode(
    const uint8_t & _arg)
  {
    this->rc_input_mode = _arg;
    return *this;
  }
  ...
  static constexpr uint8_t NAVIGATION_STATE_AUTO_LANDENGFAIL =
    8u;
  static constexpr uint8_t NAVIGATION_STATE_AUTO_LANDGPSFAIL =
    9u;
  ...
  static constexpr uint8_t NAVIGATION_STATE_MAX =
    22u;
  static constexpr uint8_t RC_IN_MODE_DEFAULT =
    0u;
  static constexpr uint8_t RC_IN_MODE_OFF =
    1u;
  static constexpr uint8_t RC_IN_MODE_GENERATED =
    2u;
  ...
  bool operator==(const VehicleStatus_ & other) const
  {
    ...
    if (this->rc_input_mode != other.rc_input_mode) {
      return false;
    }
...
template<typename ContainerAllocator>
constexpr uint8_t VehicleStatus_<ContainerAllocator>::NAVIGATION_STATE_AUTO_LANDGPSFAIL;
template<typename ContainerAllocator>
...
template<typename ContainerAllocator>
constexpr uint8_t VehicleStatus_<ContainerAllocator>::RC_IN_MODE_DEFAULT;
template<typename ContainerAllocator>
constexpr uint8_t VehicleStatus_<ContainerAllocator>::RC_IN_MODE_OFF;
template<typename ContainerAllocator>
constexpr uint8_t VehicleStatus_<ContainerAllocator>::RC_IN_MODE_GENERATED;
template<typename ContainerAllocator>
