...
class Metaclass_EscReport(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'FAILURE_OVER_CURRENT_MASK': cls.__constants['FAILURE_OVER_CURRENT_MASK'],
            'FAILURE_OVER_VOLTAGE_MASK': cls.__constants['FAILURE_OVER_VOLTAGE_MASK'],
            'FAILURE_OVER_TEMPERATURE_MASK': cls.__constants['FAILURE_OVER_TEMPERATURE_MASK'],
            'FAILURE_OVER_RPM_MASK': cls.__constants['FAILURE_OVER_RPM_MASK'],
            'FAILURE_INCONSISTENT_CMD_MASK': cls.__constants['FAILURE_INCONSISTENT_CMD_MASK'],
            'FAILURE_MOTOR_STUCK_MASK': cls.__constants['FAILURE_MOTOR_STUCK_MASK'],
            'FAILURE_GENERIC_MASK': cls.__constants['FAILURE_GENERIC_MASK'],
        }

    @property
    def FAILURE_NONE(self):
        """Message constant 'FAILURE_NONE'."""
        return Metaclass_EscReport.__constants['FAILURE_NONE']

    @property
    def FAILURE_OVER_CURRENT_MASK(self):
        """Message constant 'FAILURE_OVER_CURRENT_MASK'."""
        return Metaclass_EscReport.__constants['FAILURE_OVER_CURRENT_MASK']

    @property
    def FAILURE_OVER_VOLTAGE_MASK(self):
        """Message constant 'FAILURE_OVER_VOLTAGE_MASK'."""
        return Metaclass_EscReport.__constants['FAILURE_OVER_VOLTAGE_MASK']

    @property
    def FAILURE_OVER_TEMPERATURE_MASK(self):
        """Message constant 'FAILURE_OVER_TEMPERATURE_MASK'."""
        return Metaclass_EscReport.__constants['FAILURE_OVER_TEMPERATURE_MASK']

    @property
    def FAILURE_OVER_RPM_MASK(self):
        """Message constant 'FAILURE_OVER_RPM_MASK'."""
        return Metaclass_EscReport.__constants['FAILURE_OVER_RPM_MASK']

    @property
    def FAILURE_INCONSISTENT_CMD_MASK(self):
        """Message constant 'FAILURE_INCONSISTENT_CMD_MASK'."""
        return Metaclass_EscReport.__constants['FAILURE_INCONSISTENT_CMD_MASK']

    @property
    def FAILURE_MOTOR_STUCK_MASK(self):
        """Message constant 'FAILURE_MOTOR_STUCK_MASK'."""
        return Metaclass_EscReport.__constants['FAILURE_MOTOR_STUCK_MASK']

    @property
    def FAILURE_GENERIC_MASK(self):
        """Message constant 'FAILURE_GENERIC_MASK'."""
        return Metaclass_EscReport.__constants['FAILURE_GENERIC_MASK']
...
class EscReport(metaclass=Metaclass_EscReport):
    ...
    Constants:
      FAILURE_NONE
      FAILURE_OVER_CURRENT_MASK
      FAILURE_OVER_VOLTAGE_MASK
      FAILURE_OVER_TEMPERATURE_MASK
      FAILURE_OVER_RPM_MASK
      FAILURE_INCONSISTENT_CMD_MASK
      FAILURE_MOTOR_STUCK_MASK
      FAILURE_GENERIC_MASK
    """
    ...
    def failures(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'failures' field must be an unsigned integer in [0, 255]"
