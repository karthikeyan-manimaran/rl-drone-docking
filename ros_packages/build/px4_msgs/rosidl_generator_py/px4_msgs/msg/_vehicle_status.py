...
class Metaclass_VehicleStatus(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'NAVIGATION_STATE_AUTO_LANDGPSFAIL': cls.__constants['NAVIGATION_STATE_AUTO_LANDGPSFAIL'],
            ...
            'RC_IN_MODE_DEFAULT': cls.__constants['RC_IN_MODE_DEFAULT'],
            'RC_IN_MODE_OFF': cls.__constants['RC_IN_MODE_OFF'],
            'RC_IN_MODE_GENERATED': cls.__constants['RC_IN_MODE_GENERATED'],
    ...
    @property
    def NAVIGATION_STATE_AUTO_LANDGPSFAIL(self):
        """Message constant 'NAVIGATION_STATE_AUTO_LANDGPSFAIL'."""
        return Metaclass_VehicleStatus.__constants['NAVIGATION_STATE_AUTO_LANDGPSFAIL']
    ...
    @property
    def RC_IN_MODE_DEFAULT(self):
        """Message constant 'RC_IN_MODE_DEFAULT'."""
        return Metaclass_VehicleStatus.__constants['RC_IN_MODE_DEFAULT']

    @property
    def RC_IN_MODE_OFF(self):
        """Message constant 'RC_IN_MODE_OFF'."""
        return Metaclass_VehicleStatus.__constants['RC_IN_MODE_OFF']

    @property
    def RC_IN_MODE_GENERATED(self):
        """Message constant 'RC_IN_MODE_GENERATED'."""
        return Metaclass_VehicleStatus.__constants['RC_IN_MODE_GENERATED']
...
class VehicleStatus(metaclass=Metaclass_VehicleStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.rc_input_mode = kwargs.get('rc_input_mode', int())
    ...
    def __eq__(self, other):
        ...
        if self.rc_signal_lost != other.rc_signal_lost:
            return False
        if self.rc_input_mode != other.rc_input_mode:
            return False
    ...
    @property
    def rc_input_mode(self):
        """Message field 'rc_input_mode'."""
        return self._rc_input_mode

    @rc_input_mode.setter
    def rc_input_mode(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'rc_input_mode' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'rc_input_mode' field must be an unsigned integer in [0, 255]"
        self._rc_input_mode = value
    ...
    def onboard_control_sensors_present(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 4294967296, \
                "The 'onboard_control_sensors_present' field must be an unsigned integer in [0, 4294967295]"
    ...
    def onboard_control_sensors_enabled(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 4294967296, \
                "The 'onboard_control_sensors_enabled' field must be an unsigned integer in [0, 4294967295]"
