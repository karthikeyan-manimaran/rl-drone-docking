...
class Init_VehicleStatus_rc_input_mode
{
public:
  explicit Init_VehicleStatus_rc_input_mode(::px4_msgs::msg::VehicleStatus & msg)
  : msg_(msg)
  {}
  Init_VehicleStatus_data_link_lost rc_input_mode(::px4_msgs::msg::VehicleStatus::_rc_input_mode_type arg)
  {
    msg_.rc_input_mode = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_VehicleStatus_rc_input_mode rc_signal_lost(::px4_msgs::msg::VehicleStatus::_rc_signal_lost_type arg)
  {
    msg_.rc_signal_lost = std::move(arg);
    return Init_VehicleStatus_rc_input_mode(msg_);
  }
