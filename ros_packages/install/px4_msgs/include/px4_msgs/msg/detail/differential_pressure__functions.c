...
px4_msgs__msg__DifferentialPressure__are_equal(const px4_msgs__msg__DifferentialPressure * lhs, const px4_msgs__msg__DifferentialPressure * rhs)
{
  ...
  // differential_pressure_raw_pa
  if (lhs->differential_pressure_raw_pa != rhs->differential_pressure_raw_pa) {
    return false;
  }
  // differential_pressure_filtered_pa
  if (lhs->differential_pressure_filtered_pa != rhs->differential_pressure_filtered_pa) {
    return false;
  }
  // temperature
  ...
  px4_msgs__msg__DifferentialPressure * output)
{
  ...
  // differential_pressure_raw_pa
  output->differential_pressure_raw_pa = input->differential_pressure_raw_pa;
  // differential_pressure_filtered_pa
  output->differential_pressure_filtered_pa = input->differential_pressure_filtered_pa;
  // temperature
