...
class GazeboRunnerNode:
    ...
    def start_gazebo(self):
        ...
        if self.train:
           cmd = ["make", "px4_sitl_rtps", "gazebo_iris_irlock", "PX4_SIM_SPEED_FACTOR=2", "PX4_NO_FOLLOW_MODE=1"]
           if self.headless:
              cmd.append("HEADLESS=1")
           self.gazebo = subprocess.Popen(cmd, cwd="/src/PX4-Autopilot")
